...
public class Amazon_B2C_Check_Product_Details_Display {
	...
	@FindBy(xpath="(//span[.='2,989'])[1]")
	WebElement price_ele;
	...
	public void check_price_visible()
	{
		boolean status = price_ele.isDisplayed();
		Assert.assertEquals(status,true);
	}
	
	//step3:
	public Amazon_B2C_Check_Product_Details_Display(WebDriver driver)
	{
